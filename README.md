...
This project implements a **Flight Booking System** using Spring Boot (Web), Java 17, and MongoDB.  
The system is designed as a set of microservices, each responsible for a specific domain, with centralized configuration and resilient communication patterns.
...
- **Airline Service**: list airlines and by id  
...
- Config Server link: [flightbookingsystem-config-server](https://github.com/Pranitha161/flightbookingsystem-config-server)  

### API Gateway
- Single entry point for routing requests to microservices  

### Circuit Breaker
- Isolates failures and ensures graceful fallback in case of service downtime  

### Global Exception Handling
- Validation errors handled consistently across services  
...
### Code Quality
- SonarQube analysis for coverage, bugs, and maintainability  
